...
$data = $koneksi->query("SELECT * FROM kas WHERE id_admin = $id_admin");
?>
<!DOCTYPE html>
<html lang="id">
...
<body>
    ...
    <div class="welcome-text">
        ...
        <p>Terima kasih telah login ke Sistem Pencatatan Kas. Kelola dan pantau keuangan Anda dengan mudah dan efisien.</p>
    </div>
    ...
    <div class="wrapper">
        ...
        <div class="judul-menu">
            <h1 class="menu">Berbagai Pilihan Menu</h1>
        </div>
        <section class="layout">
            <div class="menu-box"><a href="input_pemasukan.php">Input Pemasukan</a><br>Catat uang kas beserta keterangan dan tanggal</div>
